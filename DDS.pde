...
/*
3137660
 increment=(pow(2,32)*freq)/(6242584);
 increment2=pow(2,32)*freq2/ (6246000);
 increment3=pow(2,32)*freq/ (6275320);
 
 if (dronemode==2){
 releaselength = 40;
 
 osc =((pgm_read_byte(&waveTable[index2+waveoff])))+(((pgm_read_byte( &waveTable[index2+waveoff]))+bpot<<4));
